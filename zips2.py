    ...
    #for file in range(2):
        for file in files:
            if file.endswith(".xlsx") and not file.endswith(".zip"):
                ...
                df.loc[year, f"{country_name} [P10]"] = I10
                df.loc[year, f"{country_name} [P11]"] = I11

                print(df)
print(df)
# save the data frame to a CSV file
df.to_csv(r'C:\Users\Klara\Documents\Prace\JRC\Teleworking\2023\SOC_LULUCF\data\data_P10_P11.csv')